...
# File paths per rank
input_file = f"datasets/merger_trees_1000_feat_npart/full_data_rank_{rank}.hdf5"
output_file = f"datasets/prune_merger_trees_1000_feat_npart/prune_data_rank_{rank}.hdf5"
